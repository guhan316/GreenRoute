...
export default function MultiStopPlanner() {
  ...
  async function submit(event) {
    ...
    try { setResult(await planMultiStop({ depot: depot.place, stops: stops.map(s => ({ place: s.place, weight_kg: Number(s.weight) })), return_to_depot: roundTrip, vehicle_type: 'lcv' })) }
